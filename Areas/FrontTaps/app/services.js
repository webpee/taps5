...
.controller('Ctrl', function ($scope, $localStorage, localStorageService, $cookies) {
    ...
    //localStorageService.set('conditions', null);
    if (localStorageService.get('conditions') != null)
        $scope.conditions = localStorageService.get('conditions');
    else
        $scope.conditions = [
        {
            name: 'Remanufactured Parts (REMAN)',
            value: '',
            parent: '',
            disabled: false,
        }, {
            name: 'Good Quality Used Parts (GQUP)',
            value: '',
            parent: '',
            disabled: false,
        },
        ...
        {
            name: 'Original (NP-Ori)',
            value: '',
            parent: '-1',
            disabled: false,
        },
        {
            name: 'Non-Original (NP-Non-Ori)',
            value: '',
            parent: '-1',
            disabled: false,
        }];

    //localStorageService.add('conditions', $scope.conditions);
    ...
    $scope.others = [{
        name: 'Service Parts (SP)',
        value: 'SP',
        parent: '',
        disabled: true,
    }, {
        name: 'Original (SP-Ori)',
        value: 'SP-Ori',
        parent: '-1',
        disabled: false,
    }, {
        name: 'Non-Original (SP-Non-Ori)',
        value: 'SP-Non-Ori',
        parent: '-1',
        disabled: false,
    }, {
         ...
         if (cartItemsm == null) {
             var cartItems =
                [{
                    ...
                    MovingAvgPrice: o.MovingAvgPrice
                }];
