...
! function () {
    ...
    dimple.axis = function (a, b, c, d, e) {
        this.chart = a, this.position = b, this.categoryFields = null === e || void 0 === e ? c : [].concat(e), this.measure = d, this.timeField = e, this.floatingBarWidth = 5, this.hidden = !1, this.showPercent = !1, this.colors = null, this.overrideMin = null, this.overrideMax = null, this.shapes = null, this.showGridlines = null, this.gridlineShapes = null, this.titleShape = null, this.dateParseFormat = null, this.tickFormat = null, this.timePeriod = null, this.timeInterval = 1, this.useLog = !1, this.logBase = 10, this._scale = null, this._min = 0, this._max = 0, this._previousOrigin = null, this._origin = null, this._orderRules = [], this._groupOrderRules = [], this._draw = null, this._getFormat = function () {
            ...
            return !this._hasTimeField || null !== this.timePeriod && void 0 !== this.timePeriod || (a = b >= c / 1e3 ? d3.time.seconds : b >= c / 6e4 ? d3.time.minutes : b >= c / 36e5 ? d3.time.hours : b >= c / 864e5 ? d3.time.days : b >= c / 6048e5 ? d3.time.weeks : b >= c / 26298e5 ? d3.time.months : d3.time.years), a
            ...
            var b, c, d, e, f = [],
                g = function (a, b, c) {
                    var d, e = a.categoryFields[0],
                        f = e,
                        g = !1,
                        h = !0,
                        i = [];
                    for (d = 0; d < a.chart.data.length; d += 1)
                        if (isNaN(a._parseDate(a.chart.data[d][e]))) {
                            h = !1;
                            break
                        }
                    return h || a.chart.series.forEach(function (d) {
                        d[b] === a && d[c]._hasMeasure() && (f = d[c].measure, g = !0)
                    }, this), i = a._orderRules.concat({
                        ordering: f,
                        desc: g
                    }), dimple._getOrderedList(a.chart.data, e, i)
                };
            if (this._min = this.showPercent && this._min < -1 ? -1 : this._min, this._max = this.showPercent && this._max > 1 ? 1 : this._max, this._min = null !== this.overrideMin ? this.overrideMin : this._min, this._max = null !== this.overrideMax ? this.overrideMax : this._max, "x" === this.position) {
                if (this._hasTimeField() ? this._scale = d3.time.scale().rangeRound([this.chart._xPixels(), this.chart._xPixels() + this.chart._widthPixels()]).domain([this._min, this._max]) : this.useLog ? this._scale = d3.scale.log().range([this.chart._xPixels(), this.chart._xPixels() + this.chart._widthPixels()]).domain([0 === this._min ? Math.pow(this.logBase, -1) : this._min, 0 === this._max ? -1 * Math.pow(this.logBase, -1) : this._max]).clamp(!0).base(this.logBase).nice() : null === this.measure || void 0 === this.measure ? (f = g(this, "x", "y"), this._scale = d3.scale.ordinal().rangePoints([this.chart._xPixels(), this.chart._xPixels() + this.chart._widthPixels()]).domain(f.concat([""]))) : this._scale = d3.scale.linear().range([this.chart._xPixels(), this.chart._xPixels() + this.chart._widthPixels()]).domain([this._min, this._max]).nice(), !this.hidden) switch (this.chart._axisIndex(this, "x")) {
                    case 0:
            ...
            } else this.position.length > 0 && "z" === this.position[0] ? this._scale = this.useLog ? d3.scale.log().range([this.chart._heightPixels() / 300, this.chart._heightPixels() / 10]).domain([0 === this._min ? Math.pow(this.logBase, -1) : this._min, 0 === this._max ? -1 * Math.pow(this.logBase, -1) : this._max]).clamp(!0).base(this.logBase) : d3.scale.linear().range([this.chart._heightPixels() / 300, this.chart._heightPixels() / 10]).domain([this._min, this._max]) : this.position.length > 0 && "c" === this.position[0] && (this._scale = d3.scale.linear().range([0, null === this.colors || 1 === this.colors.length ? 1 : this.colors.length - 1]).domain([this._min, this._max]));
            return null !== a && void 0 !== a && a !== !1 || this._hasTimeField() || null === this._scale || null === this._scale.ticks || void 0 === this._scale.ticks || !(this._scale.ticks(10).length > 0) || "x" !== this.position && "y" !== this.position || (b = this._scale.ticks(10), c = b[1] - b[0], d = ((this._max - this._min) % c).toFixed(0), 0 !== d && (this._max = Math.ceil(this._max / c) * c, this._min = Math.floor(this._min / c) * c, this._update(!0))), e = null !== f && void 0 !== f && f.length > 0 ? this._scale.copy()(f[0]) : this._scale.copy()(0), this._origin !== e && (this._previousOrigin = null === this._origin ? e : this._origin, this._origin = e), this
        ...
        this.svg = a, this.x = "10%", this.y = "10%", this.width = "80%", this.height = "80%", this.data = b, this.noFormats = !1, this.axes = [], this.series = [], this.legends = [], this.storyboard = null, this.titleShape = null, this.shapes = null, this._group = a.append("g"), this._tooltipGroup = null, this._assignedColors = {}, this._nextColor = 0, this._axisIndex = function (a, b) {
            var c = 0,
                d = 0,
                e = -1;
            ...
            null !== this.series && void 0 !== this.series && this.series.forEach(function (a) {
                var b, c, d = [],
                    ...
                    w = this.data,
                    x = [];
                null !== this.storyboard && void 0 !== this.storyboard && this.storyboard.categoryFields.length > 0 && (n = this.storyboard.categoryFields[0], o = dimple._getOrderedList(this.data, n, this.storyboard._orderRules)), a.x._hasCategories() && a.x._hasMeasure() && (r = a.x.categoryFields[0], s = dimple._getOrderedList(this.data, r, a.x._orderRules.concat([{
                    ordering: a.x.measure,
                    desc: !0
                }]))), a.y._hasCategories() && a.y._hasMeasure() && (t = a.y.categoryFields[0], u = dimple._getOrderedList(this.data, t, a.y._orderRules.concat([{
                    ordering: a.y.measure,
                    desc: !0
                }]))), null !== a.categoryFields && void 0 !== a.categoryFields && a.categoryFields.length > 0 && (v = [].concat(a._orderRules), p = a.categoryFields[0], null !== a.c && void 0 !== a.c && a.c._hasMeasure() ? v.push({
                    ...
                    ordering: a.y.measure,
                    desc: !0
                }), q = dimple._getOrderedList(this.data, p, v)), w.sort(function (a, b) {
                    var c = 0;
                    return "" !== n && (c = o.indexOf(a[n]) - o.indexOf(b[n])), "" !== r && 0 === c && (c = s.indexOf(a[r]) - s.indexOf(b[r])), "" !== t && 0 === c && (c = u.indexOf(a[t]) - u.indexOf(b[t])), "" !== p && 0 === c && (c = q.indexOf(a[p]) - q.indexOf(b[p])), c
                    ...
                    var c, g, h, i, j = -1,
                        ...
                        m = e(a.z, b),
                        n = [];
                    for (null === a.categoryFields || void 0 === a.categoryFields || 0 === a.categoryFields.length ? n = ["All"] : 1 === a.categoryFields.length && void 0 === b[a.categoryFields[0]] ? n = [a.categoryFields[0]] : a.categoryFields.forEach(function (a) {
                        n.push(b[a])
                    }, this), c = n.join("/") + "_" + k.join("/") + "_" + l.join("/") + "_" + m.join("/"), g = 0; g < d.length; g += 1)
                        if (d[g].key === c) {
                            j = g;
                            break
                        } -1 === j && (h = {
                            ...
                            fill: {},
                            stroke: {}
                        }, d.push(h), j = d.length - 1), i = function (c, e) {
                            var g, h, i = !0,
                                k = {
                                    value: 0,
                                    count: 1
                            ...
                            null !== e && (g = e.getFrameValue(), e.categoryFields.forEach(function (a, c) {
                                c > 0 && (m += "/"), m += b[a], i = m === g
                            }, this)), null !== c && void 0 !== c && i && (h = d[j], c._hasMeasure() && (void 0 === b[c.measure] && (b[c.measure] = 0), -1 === h[c.position + "ValueList"].indexOf(b[c.measure]) && h[c.position + "ValueList"].push(b[c.measure]), isNaN(parseFloat(b[c.measure])) && (f[c.position] = !0), k.value = h[c.position + "Value"], k.count = h[c.position + "Count"], l.value = b[c.measure], h[c.position + "Value"] = a.aggregate(k, l), h[c.position + "Count"] += 1))
                        }, i(a.x, this.storyboard), i(a.y, this.storyboard), i(a.z, this.storyboard), i(a.c, this.storyboard)
                }, this), null !== a.x && void 0 !== a.x && a.x._hasCategories() && a.x.categoryFields.length > 1 && void 0 !== g.x && (x = [], a.y._hasMeasure() && x.push({
                    ordering: a.y.measure,
                    desc: !0
                }), g.x = dimple._getOrderedList(this.data, a.x.categoryFields[1], a.x._groupOrderRules.concat(x))), null !== a.y && void 0 !== a.y && a.y._hasCategories() && a.y.categoryFields.length > 1 && void 0 !== g.y && (x = [], a.x._hasMeasure() && x.push({
                    ordering: a.x.measure,
                    desc: !0
                }), g.y = dimple._getOrderedList(this.data, a.y.categoryFields[1], a.y._groupOrderRules.concat(x)), g.y.reverse()), d.forEach(function (c) {
            ...
            null !== a._eventHandlers && a._eventHandlers.length > 0 && a._eventHandlers.forEach(function (b) {
                null !== b.handler && "function" == typeof b.handler && a.shapes.on(b.event, function (c) {
            ...
            var e = new dimple.axis(this, a, b, c, d);
            return this.axes.push(e), e
            ...
            return (void 0 === b || null === b || b === !1) && this._getSeriesData(), this.axes.forEach(function (a) {
                if (a._min = 0, a._max = 0, a._hasMeasure()) {
                    ...
                    }, this), b || this.data.forEach(function (b) {
                        a._min > b[a.measure] && (a._min = b[a.measure]), a._max < b[a.measure] && (a._max = b[a.measure])
                    }, this)
                } else a._hasTimeField() ? (a._min = null, a._max = null, this.data.forEach(function (b) {
                    var c = a._parseDate(b[a.timeField]);
                    (null === a._min || c < a._min) && (a._min = c), (null === a._max || c > a._max) && (a._max = c)
                }, this)) : a._hasCategories() && (a._min = 0, c = [], this.data.forEach(function (b) {
                    -1 === c.indexOf(b[a.categoryFields[0]]) && c.push(b[a.categoryFields[0]])
                }, this), a._max = c.length);
                a._update(), null === d && "x" === a.position ? d = a : null === e && "y" === a.position && (e = a)
                ...
                }), "x" === b.position ? (t = b === d ? i + k + r.b + 5 : i + r.t - 10, s = h + j / 2) : "y" === b.position && (s = b === e ? h + r.l - 10 : h + j + r.r + 20, t = i + k / 2, u = "rotate(270, " + s + ", " + t + ")"), b.hidden || "x" !== b.position && "y" !== b.position || (b.titleShape = this._group.append("text").attr("class", "axis title"), b.titleShape.attr("x", s).attr("y", t).attr("text-anchor", "middle").attr("transform", u).text(null === b.categoryFields || void 0 === b.categoryFields || 0 === b.categoryFields.length ? b.measure : b.categoryFields.join("/")).each(function () {
                    v.noFormats || d3.select(this).style("font-family", "sans-serif").style("font-size", (k / 35 > 10 ? k / 35 : 10) + "px")
                }), b === d ? b.titleShape.each(function () {
                    d3.select(this).attr("y", t + this.getBBox().height / 1.65)
                }) : b === e && b.titleShape.each(function () {
                    d3.select(this).attr("x", s + this.getBBox().height / 1.65)
                }))
        ...
        this.chart = a, this.series = g, this.x = b, this.y = c, this.width = d, this.height = e, this.horizontalAlign = f, this.shapes = null, this._draw = function (a) {
            var b, c = this._getEntries(),
                ...
                i = 9,
                j = this;
            null !== this.shapes && void 0 !== this.shapes && this.shapes.transition().duration(.2 * a).attr("opacity", 0).remove(), b = this.chart._group.selectAll(".dontSelectAny").data(c).enter().append("g").attr("class", "legend").attr("opacity", 0), b.append("text").attr("id", function (a) {
                return "legend_" + a.key
            }).attr("class", "legendText").text(function (a) {
                return a.key
            }).call(function () {
                j.chart.noFormats || this.style("font-family", "sans-serif").style("font-size", (j.chart._heightPixels() / 35 > 10 ? j.chart._heightPixels() / 35 : 10) + "px").style("shape-rendering", "crispEdges")
            }).each(function () {
                var a = this.getBBox();
                a.width > d && (d = a.width), a.height > e && (e = a.height)
            }), b.append("rect").attr("class", "legendKey").attr("height", i).attr("width", h), e = (i > e ? i : e) + 2, d += h + 20, b.each(function (a) {
                ...
                }).attr("width", j._widthPixels()).attr("height", j._heightPixels()), d3.select(this).select("rect").attr("class", "legend legendKey").attr("x", "left" === j.horizontalAlign ? j._xPixels() + f : j._xPixels() + (j._widthPixels() - f - d)).attr("y", j._yPixels() + g).attr("height", i).attr("width", h).style("fill", function () {
                    return dimple._helpers.fill(a, j.chart, a.series)
                }).style("stroke", function () {
                    return dimple._helpers.stroke(a, j.chart, a.series)
                }).style("opacity", function () {
                    return dimple._helpers.opacity(a, j.chart, a.series)
                }).style("shape-rendering", "crispEdges"), f += d)
            }), b.transition().delay(.2 * a).duration(.8 * a).attr("opacity", 1), this.shapes = b
        }, this._getEntries = function () {
            var a = [];
            return null !== this.series && void 0 !== this.series && this.series.forEach(function (b) {
                var c = b._positionData;
                c.forEach(function (c) {
                    var d, e = -1;
                    for (d = 0; d < a.length; d += 1)
                        if (a[d].key === c.aggField.slice(-1)[0]) {
                            e = d;
                            break
                        } -1 === e && (a.push({
                            key: c.aggField.slice(-1)[0],
                            fill: c.fill,
                            stroke: c.stroke,
                            series: b,
                            aggField: c.aggField
        ...
        this.chart = a, this.x = c, this.y = d, this.z = e, this.c = f, this.plot = g, this.categoryFields = b, this.aggregate = h, this.stacked = i, this.barGap = .2, this.clusterBarGap = .1, this.lineWeight = 2, this.lineMarkers = !1, this._eventHandlers = [], this._positionData = [], this._orderRules = [], this._axisBounds = function (a) {
            var b, c, d, e = {
                min: 0,
                max: 0
            }, f = null,
            ...
            return "x" === a ? (f = this.x, g = this.y) : "y" === a ? (f = this.y, g = this.x) : "z" === a ? f = this.z : "c" === a && (f = this.c), f.showPercent ? j.forEach(function (a) {
                ...
                !this.stacked || "x" !== f.position && "y" !== f.position ? (a[f.position + "Value"] < e.min && (e.min = a[f.position + "Value"]), a[f.position + "Value"] > e.max && (e.max = a[f.position + "Value"])) : a[f.position + "Value"] < 0 ? e.min = e.min + a[f.position + "Value"] : e.max = e.max + a[f.position + "Value"]
            ...
            return this.chart.axes.forEach(function (a) {
                ...
                "x" !== e.position || this.x.hidden ? "y" !== e.position || this.y.hidden || (e === this.y && (0 === b ? c.x = d.x : 1 === b && (c.x = this.chart._xPixels() + this.chart._widthPixels())), b += 1) : (e === this.x && (0 === a ? c.y = d.y : 1 === a && (c.y = this.chart._yPixels())), a += 1)
            }, this), c
        ...
        null !== b && void 0 !== b && (b = [].concat(b)), this.chart = a, this.categoryFields = b, this.autoplay = !0, this.frameDuration = 3e3, this.storyLabel = null, this.onTick = null, this._frame = 0, this._animationTimer = null, this._categories = [], this._cachedCategoryFields = [], this._orderRules = [], this._drawText = function (a) {
            if (null === this.storyLabel || void 0 === this.storyLabel) {
                var b = this.chart,
                    c = 0;
                this.chart.axes.forEach(function (a) {
                    "x" === a.position && (c += 1)
                }, this), this.storyLabel = this.chart._group.append("text").attr("x", this.chart._xPixels() + .01 * this.chart._widthPixels()).attr("y", this.chart._yPixels() + (this.chart._heightPixels() / 35 > 10 ? this.chart._heightPixels() / 35 : 10) * (c > 1 ? 1.25 : -1)).call(function () {
                    b.noFormats || this.style("font-family", "sans-serif").style("font-size", (b._heightPixels() / 35 > 10 ? b._heightPixels() / 35 : 10) + "px")
                })
            }
            this.storyLabel.transition().duration(.2 * a).attr("opacity", 0), this.storyLabel.transition().delay(.2 * a).text(this.categoryFields.join("\\") + ": " + this.getFrameValue()).transition().duration(.8 * a).attr("opacity", 1)
        }, this._getCategories = function () {
            return this._categoryFields !== this._cachedCategoryFields && (this._categories = [], this.chart.data.forEach(function (a) {
                var b = -1,
                    c = "";
        ...
        draw: function (a, b, c) {
            var d, e, f = this,
                ...
                j = !1,
                k = {};
            null !== a._tooltipGroup && void 0 !== a._tooltipGroup && a._tooltipGroup.remove(), (b.x._hasCategories() || b.y._hasCategories()) && (i = 0), g.forEach(function (a) {
                var b, c = [],
                    d = !1;
                for (b = i; b < a.aggField.length; b += 1) c.push(a.aggField[b]);
                h.forEach(function (a) {
                    d = d || a === c.join("/")
                }, this), d || h.push(c.join("/"))
            }, this), null !== b.c && void 0 !== b.c && (b.x._hasCategories() && b.y._hasMeasure() || b.y._hasCategories() && b.x._hasMeasure()) && (j = !0, h.forEach(function (d) {
                dimple._addGradient(d, "fill-area-gradient-" + d.join("_").replace(" ", ""), b.x._hasCategories() ? b.x : b.y, g, a, c, "fill"), dimple._addGradient(d, "stroke-area-gradient-" + d.join("_").replace(" ", ""), b.x._hasCategories() ? b.x : b.y, g, a, c, "stroke")
            }, this)), d = d3.svg.line().x(function (c) {
                return dimple._helpers.cx(c, a, b)
            }).y(function (c) {
                return dimple._helpers.cy(c, a, b)
            }), (null === b.shapes || void 0 === b.shapes) && (b.shapes = a._group.selectAll(".area").data(h).enter().append("svg:path").attr("opacity", function (b) {
                return a.getColor(b).opacity
            })), b.shapes.data(h).transition().duration(c).attr("class", function (a) {
                return "series area " + a.replace(" ", "")
            }).attr("d", function (c) {
                var e, f, h, i, j, l, m, n, o = [],
                    p = 0;
                for (e = dimple.filterData(g, "aggField", c), e.sort(function (c, d) {
                    var e = 0;
                    return b.x._hasCategories() ? e = dimple._helpers.cx(c, a, b) < dimple._helpers.cx(d, a, b) ? -1 : 1 : b.y._hasCategories() && (e = dimple._helpers.cy(c, a, b) < dimple._helpers.cy(d, a, b) ? -1 : 1), e
                    ...
                    if (f = e[i], h = {
                        ...
                        if (h.cx = f.cx, h.width = f.width, h.xOffset = f.xOffset, void 0 === k[f.xField]) k[f.xField] = [];
                        else {
                            for (p = 0, j = 0; j <= k[f.xField].length; j += 1) m = k[f.xField][j], (f.cy >= 0 && m >= 0 || f.cy <= 0 && 0 >= m) && Math.abs(m) <= Math.abs(f.cy) && Math.abs(m) > Math.abs(p) && (p = m);
                            h.cy = p
                        }
                        o.push(h), k[f.xField].push(f.cy)
                    } else if (b.y._hasCategories()) {
                        if (h.cy = f.cy, h.height = f.height, h.yOffset = f.yOffset, void 0 === k[f.yField]) k[f.yField] = [];
                        else {
                            for (p = 0, l = 0; l <= k[f.yField].length; l += 1) n = k[f.yField][l], (f.cx >= 0 && n >= 0 || f.cx <= 0 && 0 >= n) && Math.abs(n) <= Math.abs(f.cx) && Math.abs(n) > Math.abs(p) && (p = n);
                            h.cx = p
                        }
                        o.push(h), k[f.yField].push(f.cx)
                    }
                return d(e.concat(o).concat(e[0]))
            }).call(function () {
                a.noFormats || this.attr("fill", function (b) {
                    return j ? "url(#fill-area-gradient-" + b.join("_").replace(" ", "") + ")" : a.getColor(b).fill
                }).attr("stroke", function (b) {
                    return j ? "url(#stroke-area-gradient-" + b.join("_").replace(" ", "") + ")" : a.getColor(b).stroke
                }).attr("stroke-width", b.lineWeight)
            }), e = a._group.selectAll(".markers").data(g).enter(), b.lineMarkers && e.append("circle").transition().duration(c).attr("cx", function (c) {
                return dimple._helpers.cx(c, a, b)
            }).attr("cy", function (c) {
                return dimple._helpers.cy(c, a, b)
            }).attr("r", 2 + b.lineWeight).attr("fill", "white").attr("stroke", "none"), e.append("circle").on("mouseover", function (c) {
                f.enterEventHandler(c, this, a, b)
            }).on("mouseleave", function (c) {
                f.leaveEventHandler(c, this, a, b)
            }).transition().duration(c).attr("cx", function (c) {
                return dimple._helpers.cx(c, a, b)
            }).attr("cy", function (c) {
                return dimple._helpers.cy(c, a, b)
            }).attr("r", 2 + b.lineWeight).attr("opacity", function (c) {
                return b.lineMarkers ? a.getColor(c).opacity : 0
            }).call(function () {
                a.noFormats || this.attr("fill", "white").style("stroke-width", b.lineWeight).attr("stroke", function (c) {
        ...
        enterEventHandler: function (a, b, c, d) {
            var e, f, g, h = 5,
                ...
                j = 750,
                k = d3.select(b),
                l = parseFloat(k.attr("cx")),
                m = parseFloat(k.attr("cy")),
                n = parseFloat(k.attr("r")),
                o = dimple._helpers.opacity(a, c, d),
                p = dimple._helpers.fill(a, c, d),
                q = d._dropLineOrigin(),
                r = d3.rgb(d3.rgb(p).r + .6 * (255 - d3.rgb(p).r), d3.rgb(p).g + .6 * (255 - d3.rgb(p).g), d3.rgb(p).b + .6 * (255 - d3.rgb(p).b)),
                s = d3.rgb(d3.rgb(p).r + .8 * (255 - d3.rgb(p).r), d3.rgb(p).g + .8 * (255 - d3.rgb(p).g), d3.rgb(p).b + .8 * (255 - d3.rgb(p).b)),
                t = 0,
                u = 0,
                v = 0,
                w = [];
            null !== c._tooltipGroup && void 0 !== c._tooltipGroup && c._tooltipGroup.remove(), c._tooltipGroup = c.svg.append("g"), k.style("opacity", 1), c._tooltipGroup.append("circle").attr("cx", l).attr("cy", m).attr("r", n).attr("opacity", 0).style("fill", "none").style("stroke", p).style("stroke-width", 1).transition().duration(j / 2).ease("linear").attr("opacity", 1).attr("r", n + 4).style("stroke-width", 2), null !== q.y && c._tooltipGroup.append("line").attr("x1", l).attr("y1", m < q.y ? m + n + 4 : m - n - 4).attr("x2", l).attr("y2", m < q.y ? m + n + 4 : m - n - 4).style("fill", "none").style("stroke", p).style("stroke-width", 2).style("stroke-dasharray", "3, 3").style("opacity", o).transition().delay(j / 2).duration(j / 2).ease("linear").attr("y2", m < q.y ? q.y - 1 : q.y + 1), null !== q.x && c._tooltipGroup.append("line").attr("x1", l < q.x ? l + n + 4 : l - n - 4).attr("y1", m).attr("x2", l < q.x ? l + n + 4 : l - n - 4).attr("y2", m).style("fill", "none").style("stroke", p).style("stroke-width", 2).style("stroke-dasharray", "3, 3").style("opacity", o).transition().delay(j / 2).duration(j / 2).ease("linear").attr("x2", l < q.x ? q.x - 1 : q.x + 1), e = c._tooltipGroup.append("g"), f = e.append("rect"), null !== d.categoryFields && void 0 !== d.categoryFields && d.categoryFields.length > 0 && d.categoryFields.forEach(function (b, c) {
                w.push(b + (a.aggField[c] !== b ? ": " + a.aggField[c] : ""))
            }, this), d.x._hasTimeField() ? w.push(d.x.timeField + ": " + d.x._getFormat()(a.xField[0])) : d.x._hasCategories() ? d.x.categoryFields.forEach(function (b, c) {
                w.push(b + (a.xField[c] !== b ? ": " + a.xField[c] : ""))
            }, this) : w.push(d.x.measure + ": " + d.x._getFormat()(a.width)), d.y._hasTimeField() ? w.push(d.y.timeField + ": " + d.y._getFormat()(a.yField[0])) : d.y._hasCategories() ? d.y.categoryFields.forEach(function (b, c) {
                w.push(b + (a.yField[c] !== b ? ": " + a.yField[c] : ""))
            }, this) : w.push(d.y.measure + ": " + d.y._getFormat()(a.height)), null !== d.z && void 0 !== d.z && w.push(d.z.measure + ": " + d.z._getFormat()(a.zValue)), null !== d.c && void 0 !== d.c && w.push(d.c.measure + ": " + d.c._getFormat()(a.cValue)), w = w.filter(function (a, b) {
                return w.indexOf(a) === b
            }), e.selectAll(".textHoverShapes").data(w).enter().append("text").text(function (a) {
                return a
            }).style("font-family", "sans-serif").style("font-size", "10px"), e.each(function () {
                u = this.getBBox().width > u ? this.getBBox().width : u, v = this.getBBox().width > v ? this.getBBox().height : v
            }), e.selectAll("text").attr("x", 0).attr("y", function () {
                return t += this.getBBox().height, t - this.getBBox().height / 2
            }), f.attr("x", -h).attr("y", -h).attr("height", Math.floor(t + h) - .5).attr("width", u + 2 * h).attr("rx", 5).attr("ry", 5).style("fill", s).style("stroke", r).style("stroke-width", 2).style("opacity", .95), g = l + n + h + i + u > parseFloat(c.svg.attr("width")), e.attr("transform", "translate(" + (g ? l - (n + h + i + u) : l + n + h + i) + " , " + (m - (t - (v - h)) / 2) + ")")
        },
        leaveEventHandler: function (a, b, c, d) {
            d3.select(b).style("opacity", d.lineMarkers ? dimple._helpers.opacity(a, c, d) : 0), null !== c._tooltipGroup && void 0 !== c._tooltipGroup && c._tooltipGroup.remove()
        }
    }, dimple.plot.bar = {
        stacked: !0,
        supportedAxes: ["x", "y", "c"],
        draw: function (a, b, c) {
            var d = this,
                e = b._positionData,
                f = null,
                g = "series" + a.series.indexOf(b);
            null !== a._tooltipGroup && void 0 !== a._tooltipGroup && a._tooltipGroup.remove(), f = null === b.shapes || void 0 === b.shapes ? a._group.selectAll("." + g).data(e) : b.shapes.data(e, function (a) {
                return a.key
            }), f.enter().append("rect").attr("id", function (a) {
                return a.key
            }).attr("class", function (a) {
                return g + " bar " + a.aggField.join(" ") + " " + a.xField.join(" ") + " " + a.yField.join(" ")
            }).attr("x", function (c) {
                return dimple._helpers.x(c, a, b)
            }).attr("y", function (c) {
                return dimple._helpers.y(c, a, b) + dimple._helpers.height(c, a, b)
            }).attr("width", function (c) {
                return null !== c.xField && c.xField.length > 0 ? dimple._helpers.width(c, a, b) : 0
            }).attr("height", function (c) {
                return null !== c.yField && c.yField.length > 0 ? dimple._helpers.height(c, a, b) : 0
            }).attr("opacity", function (c) {
                return dimple._helpers.opacity(c, a, b)
            }).on("mouseover", function (c) {
                d.enterEventHandler(c, this, a, b)
            }).on("mouseleave", function () {
                d.leaveEventHandler(a)
            }).call(function () {
            ...
            }), f.transition().duration(c).attr("x", function (c) {
                return dimple._helpers.x(c, a, b)
            }).attr("y", function (c) {
                return dimple._helpers.y(c, a, b)
            }).attr("width", function (c) {
                return dimple._helpers.width(c, a, b)
            }).attr("height", function (c) {
                return dimple._helpers.height(c, a, b)
            }).call(function () {
                a.noFormats || this.attr("fill", function (c) {
                    return dimple._helpers.fill(c, a, b)
                }).attr("stroke", function (c) {
            ...
            }), f.exit().transition().duration(c).attr("x", function (c) {
                return dimple._helpers.x(c, a, b)
            }).attr("y", function (c) {
                return dimple._helpers.y(c, a, b)
            }).attr("width", function (c) {
        ...
        enterEventHandler: function (a, b, c, d) {
            var e, f, g = 5,
                ...
                i = 750,
                j = d3.select(b),
                k = parseFloat(j.attr("x")),
                l = parseFloat(j.attr("y")),
                m = parseFloat(j.attr("width")),
                n = parseFloat(j.attr("height")),
                o = j.attr("opacity"),
                p = j.attr("fill"),
                q = d._dropLineOrigin(),
                r = d3.rgb(d3.rgb(p).r + .6 * (255 - d3.rgb(p).r), d3.rgb(p).g + .6 * (255 - d3.rgb(p).g), d3.rgb(p).b + .6 * (255 - d3.rgb(p).b)),
                ...
                v = 0,
                w = 0;
            null !== c._tooltipGroup && void 0 !== c._tooltipGroup && c._tooltipGroup.remove(), c._tooltipGroup = c.svg.append("g"), d.x._hasCategories() || null === q.y || c._tooltipGroup.append("line").attr("x1", k < d.x._origin ? k + 1 : k + m - 1).attr("y1", l < q.y ? l + n : l).attr("x2", k < d.x._origin ? k + 1 : k + m - 1).attr("y2", l < q.y ? l + n : l).style("fill", "none").style("stroke", p).style("stroke-width", 2).style("stroke-dasharray", "3, 3").style("opacity", o).transition().delay(i / 2).duration(i / 2).ease("linear").attr("y2", l < q.y ? q.y - 1 : q.y + 1), d.y._hasCategories() || null === q.x || c._tooltipGroup.append("line").attr("x1", k < q.x ? k + m : k).attr("y1", l < d.y._origin ? l + 1 : l + n - 1).attr("x2", k < q.x ? k + m : k).attr("y2", l < d.y._origin ? l + 1 : l + n - 1).style("fill", "none").style("stroke", p).style("stroke-width", 2).style("stroke-dasharray", "3, 3").style("opacity", o).transition().delay(i / 2).duration(i / 2).ease("linear").attr("x2", k < q.x ? q.x - 1 : q.x + 1), e = c._tooltipGroup.append("g"), f = e.append("rect"), null !== d.categoryFields && void 0 !== d.categoryFields && d.categoryFields.length > 0 && d.categoryFields.forEach(function (b, c) {
                t.push(b + (a.aggField[c] !== b ? ": " + a.aggField[c] : ""))
            }, this), d.x._hasTimeField() ? t.push(d.x.timeField + ": " + d.x._getFormat()(a.xField[0])) : d.x._hasCategories() ? d.x.categoryFields.forEach(function (b, c) {
                t.push(b + (a.xField[c] !== b ? ": " + a.xField[c] : ""))
            }, this) : t.push(d.x.measure + ": " + d.x._getFormat()(a.width)), d.y._hasTimeField() ? t.push(d.y.timeField + ": " + d.y._getFormat()(a.yField[0])) : d.y._hasCategories() ? d.y.categoryFields.forEach(function (b, c) {
                t.push(b + (a.yField[c] !== b ? ": " + a.yField[c] : ""))
            }, this) : t.push(d.y.measure + ": " + d.y._getFormat()(a.height)), null !== d.c && void 0 !== d.c && t.push(d.c.measure + ": " + d.c._getFormat()(d.c.showPercent ? a.cPct : a.cValue)), t = t.filter(function (a, b) {
                return t.indexOf(a) === b
            }), e.selectAll(".textHoverShapes").data(t).enter().append("text").text(function (a) {
                return a
            }).style("font-family", "sans-serif").style("font-size", "10px"), e.each(function () {
            ...
            }), f.attr("x", -g).attr("y", -g).attr("height", Math.floor(u + g) - .5).attr("width", v + 2 * g).attr("rx", 5).attr("ry", 5).style("fill", s).style("stroke", r).style("stroke-width", 2).style("opacity", .95), k + m + g + h + v < parseFloat(c.svg.attr("width")) ? e.attr("transform", "translate(" + (k + m + g + h) + " , " + (l + n / 2 - (u - (w - g)) / 2) + ")") : k - (g + h + v) > 0 ? e.attr("transform", "translate(" + (k - (g + h + v)) + " , " + (l + n / 2 - (u - (w - g)) / 2) + ")") : l + n + u + h + g < parseFloat(c.svg.attr("height")) ? e.attr("transform", "translate(" + (k + m / 2 - (2 * g + v) / 2) + " , " + (l + n + 2 * g) + ")") : e.attr("transform", "translate(" + (k + m / 2 - (2 * g + v) / 2) + " , " + (l - u - (w - g)) + ")")
        },
        leaveEventHandler: function (a) {
            null !== a._tooltipGroup && void 0 !== a._tooltipGroup && a._tooltipGroup.remove()
        }
    }, dimple.plot.bubble = {
        stacked: !1,
        ...
        draw: function (a, b, c) {
            ...
            null !== a._tooltipGroup && void 0 !== a._tooltipGroup && a._tooltipGroup.remove(), f = null === b.shapes || void 0 === b.shapes ? a._group.selectAll("." + g).data(e) : b.shapes.data(e, function (a) {
                ...
                return g + " bubble " + a.aggField.join(" ") + " " + a.xField.join(" ") + " " + a.yField.join(" ") + " " + a.zField.join(" ")
            }).attr("cx", function (c) {
            ...
            }), f.transition().duration(c).attr("cx", function (c) {
                return dimple._helpers.cx(c, a, b)
            }).attr("cy", function (c) {
                return dimple._helpers.cy(c, a, b)
            }).attr("r", function (c) {
            ...
            }), f.exit().transition().duration(c).attr("r", 0).attr("cx", function (c) {
                return b.x._hasCategories() ? dimple._helpers.cx(c, a, b) : b.x._origin
            }).attr("cy", function (c) {
                return b.y._hasCategories() ? dimple._helpers.cy(c, a, b) : b.y._origin
            }).each("end", function () {
        ...
        enterEventHandler: function (a, b, c, d) {
            var e, f, g, h = 5,
                ...
                v = 0,
                w = 0;
            null !== c._tooltipGroup && void 0 !== c._tooltipGroup && c._tooltipGroup.remove(), c._tooltipGroup = c.svg.append("g"), c._tooltipGroup.append("circle").attr("cx", l).attr("cy", m).attr("r", n).attr("opacity", 0).style("fill", "none").style("stroke", p).style("stroke-width", 1).transition().duration(j / 2).ease("linear").attr("opacity", 1).attr("r", n + 4).style("stroke-width", 2), null !== q.y && c._tooltipGroup.append("line").attr("x1", l).attr("y1", m < q.y ? m + n + 4 : m - n - 4).attr("x2", l).attr("y2", m < q.y ? m + n + 4 : m - n - 4).style("fill", "none").style("stroke", p).style("stroke-width", 2).style("stroke-dasharray", "3, 3").style("opacity", o).transition().delay(j / 2).duration(j / 2).ease("linear").attr("y2", m < q.y ? q.y - 1 : q.y + 1), null !== q.x && c._tooltipGroup.append("line").attr("x1", l < q.x ? l + n + 4 : l - n - 4).attr("y1", m).attr("x2", l < q.x ? l + n + 4 : l - n - 4).attr("y2", m).style("fill", "none").style("stroke", p).style("stroke-width", 2).style("stroke-dasharray", "3, 3").style("opacity", o).transition().delay(j / 2).duration(j / 2).ease("linear").attr("x2", l < q.x ? q.x - 1 : q.x + 1), e = c._tooltipGroup.append("g"), f = e.append("rect"), null !== d.categoryFields && void 0 !== d.categoryFields && d.categoryFields.length > 0 && d.categoryFields.forEach(function (b, c) {
                t.push(b + (a.aggField[c] !== b ? ": " + a.aggField[c] : ""))
            }, this), d.x._hasTimeField() ? t.push(d.x.timeField + ": " + d.x._getFormat()(a.xField[0])) : d.x._hasCategories() ? d.x.categoryFields.forEach(function (b, c) {
                t.push(b + (a.xField[c] !== b ? ": " + a.xField[c] : ""))
            }, this) : t.push(d.x.measure + ": " + d.x._getFormat()(a.cx)), d.y._hasTimeField() ? t.push(d.y.timeField + ": " + d.y._getFormat()(a.yField[0])) : d.y._hasCategories() ? d.y.categoryFields.forEach(function (b, c) {
                t.push(b + (a.yField[c] !== b ? ": " + a.yField[c] : ""))
            }, this) : t.push(d.y.measure + ": " + d.y._getFormat()(a.cy)), null !== d.z && void 0 !== d.z && t.push(d.z.measure + ": " + d.z._getFormat()(a.zValue)), null !== d.c && void 0 !== d.c && t.push(d.c.measure + ": " + d.c._getFormat()(a.cValue)), t = t.filter(function (a, b) {
                return t.indexOf(a) === b
            }), e.selectAll(".textHoverShapes").data(t).enter().append("text").text(function (a) {
                return a
            }).style("font-family", "sans-serif").style("font-size", "10px"), e.each(function () {
                ...
                return u += this.getBBox().height, u - this.getBBox().height / 2
            }), f.attr("x", -h).attr("y", -h).attr("height", Math.floor(u + h) - .5).attr("width", v + 2 * h).attr("rx", 5).attr("ry", 5).style("fill", s).style("stroke", r).style("stroke-width", 2).style("opacity", .95), g = l + n + h + i + v > parseFloat(c.svg.attr("width")), e.attr("transform", "translate(" + (g ? l - (n + h + i + v) : l + n + h + i) + " , " + (m - (u - (w - h)) / 2) + ")")
        },
        leaveEventHandler: function (a) {
            null !== a._tooltipGroup && void 0 !== a._tooltipGroup && a._tooltipGroup.remove()
        }
        ...
        draw: function (a, b, c) {
            var d, e, f = this,
                ...
                j = 1,
                k = !1;
            null !== a._tooltipGroup && void 0 !== a._tooltipGroup && a._tooltipGroup.remove(), (b.x._hasCategories() || b.y._hasCategories()) && (j = 0), g.forEach(function (a) {
                var b, c = [],
                    d = !1;
                for (b = j; b < a.aggField.length; b += 1) c.push(a.aggField[b]);
                i.forEach(function (a) {
                    d = d || a.join("/") === c.join("/")
                }, this), d || i.push(c)
            }, this), null !== b.c && void 0 !== b.c && (b.x._hasCategories() && b.y._hasMeasure() || b.y._hasCategories() && b.x._hasMeasure()) && (k = !0, i.forEach(function (d) {
                dimple._addGradient(d, "fill-line-gradient-" + d.join("_").replace(" ", ""), b.x._hasCategories() ? b.x : b.y, g, a, c, "fill")
            }, this)), d = d3.svg.line().x(function (c) {
                return dimple._helpers.cx(c, a, b)
            }).y(function (c) {
                return dimple._helpers.cy(c, a, b)
            }), (null === b.shapes || void 0 === b.shapes) && (b.shapes = a._group.selectAll(".line").data(i).enter().append("svg:path").attr("opacity", function (b) {
                return a.getColor(b).opacity
            })), b.shapes.data(i).transition().duration(c).attr("class", function (a) {
                return "series line " + a.join("_").replace(" ", "")
            }).attr("d", function (c) {
                var e = [];
                return g.forEach(function (a) {
                    var b, d = !0;
                    for (b = j; b < a.aggField.length; b += 1) d = d && c[b - j] === a.aggField[b];
                    d && e.push(a)
                }, this), e.sort(function (c, d) {
                    var e = 0;
                    return b.x._hasCategories() ? e = dimple._helpers.cx(c, a, b) < dimple._helpers.cx(d, a, b) ? -1 : 1 : b.y._hasCategories() && (e = dimple._helpers.cy(c, a, b) < dimple._helpers.cy(d, a, b) ? -1 : 1), e
                }), 1 === e.length && (h.push({
                    cx: dimple._helpers.cx(e[0], a, b),
                    cy: dimple._helpers.cy(e[0], a, b),
                    opacity: a.getColor(c[c.length - 1]).opacity,
                    color: a.getColor(c[c.length - 1]).stroke
                }), d3.select(this).remove()), d(e)
            }).call(function () {
                a.noFormats || this.attr("fill", "none").attr("stroke", function (b) {
                    return k ? "url(#fill-line-gradient-" + b.join("_").replace(" ", "") + ")" : a.getColor(b[b.length - 1]).stroke
                }).attr("stroke-width", b.lineWeight)
            }), e = a._group.selectAll(".markers").data(g).enter(), b.lineMarkers && e.append("circle").transition().duration(c).attr("cx", function (c) {
                return dimple._helpers.cx(c, a, b)
            }).attr("cy", function (c) {
                ...
                a.noFormats || this.attr("fill", "white").style("stroke-width", b.lineWeight).attr("stroke", function (c) {
                    return k ? dimple._helpers.fill(c, a, b) : a.getColor(c.aggField[c.aggField.length - 1]).stroke
                })
            }), b.lineMarkers || a._group.selectAll(".fill").data(h).enter().append("circle").attr("cx", function (a) {
                return a.cx
            }).attr("cy", function (a) {
                return a.cy
            }).attr("r", b.lineWeight).attr("opacity", function (a) {
                return a.opacity
            }).call(function () {
                a.noFormats || this.attr("fill", function (a) {
                    return a.color
                }).attr("stroke", "none")
            })
        },
        enterEventHandler: function (a, b, c, d) {
            ...
            null !== c._tooltipGroup && void 0 !== c._tooltipGroup && c._tooltipGroup.remove(), c._tooltipGroup = c.svg.append("g"), k.style("opacity", 1), c._tooltipGroup.append("circle").attr("cx", l).attr("cy", m).attr("r", n).attr("opacity", 0).style("fill", "none").style("stroke", p).style("stroke-width", 1).transition().duration(j / 2).ease("linear").attr("opacity", 1).attr("r", n + d.lineWeight + 2).style("stroke-width", 2), null !== q.y && c._tooltipGroup.append("line").attr("x1", l).attr("y1", m < q.y ? m + n + d.lineWeight + 2 : m - n - d.lineWeight - 2).attr("x2", l).attr("y2", m < q.y ? m + n + d.lineWeight + 2 : m - n - d.lineWeight - 2).style("fill", "none").style("stroke", p).style("stroke-width", 2).style("stroke-dasharray", "3, 3").style("opacity", o).transition().delay(j / 2).duration(j / 2).ease("linear").attr("y2", m < q.y ? q.y - 1 : q.y + 1), null !== q.x && c._tooltipGroup.append("line").attr("x1", l < q.x ? l + n + d.lineWeight + 2 : l - n - d.lineWeight - 2).attr("y1", m).attr("x2", l < q.x ? l + n + d.lineWeight + 2 : l - n - d.lineWeight - 2).attr("y2", m).style("fill", "none").style("stroke", p).style("stroke-width", 2).style("stroke-dasharray", "3, 3").style("opacity", o).transition().delay(j / 2).duration(j / 2).ease("linear").attr("x2", l < q.x ? q.x - 1 : q.x + 1), e = c._tooltipGroup.append("g"), f = e.append("rect"), null !== d.categoryFields && void 0 !== d.categoryFields && d.categoryFields.length > 0 && d.categoryFields.forEach(function (b, c) {
                ...
                w.push(b + (a.xField[c] !== b ? ": " + a.xField[c] : ""))
            }, this) : d.x.useLog ? w.push(d.x.measure + ": " + a.cx) : w.push(d.x.measure + ": " + d.x._getFormat()(a.cx)), d.y._hasTimeField() ? w.push(d.y.timeField + ": " + d.y._getFormat()(a.yField[0])) : d.y._hasCategories() ? d.y.categoryFields.forEach(function (b, c) {
                w.push(b + (a.yField[c] !== b ? ": " + a.yField[c] : ""))
            }, this) : d.y.useLog ? w.push(d.y.measure + ": " + a.cy) : w.push(d.y.measure + ": " + d.y._getFormat()(a.cy)), null !== d.z && void 0 !== d.z && w.push(d.z.measure + ": " + d.z._getFormat()(a.zValue)), null !== d.c && void 0 !== d.c && w.push(d.c.measure + ": " + d.c._getFormat()(a.cValue)), w = w.filter(function (a, b) {
                return w.indexOf(a) === b
            }), e.selectAll(".textHoverShapes").data(w).enter().append("text").text(function (a) {
                return a
            }).style("font-family", "sans-serif").style("font-size", "10px"), e.each(function () {
        ...
        var h = e._group.select("#" + b),
            i = [],
            j = c.position + "Field",
            k = !0,
            l = [];
        d.forEach(function (a) {
            -1 === i.indexOf(a[j]) && i.push(a[j])
        }, this), i = i.sort(function (a, b) {
            return c._scale(a) - c._scale(b)
        }), null === h.node() && (k = !1, h = e._group.append("linearGradient").attr("id", b).attr("gradientUnits", "userSpaceOnUse").attr("x1", "x" === c.position ? c._scale(i[0]) + e._widthPixels() / i.length / 2 : 0).attr("y1", "y" === c.position ? c._scale(i[0]) - e._heightPixels() / i.length / 2 : 0).attr("x2", "x" === c.position ? c._scale(i[i.length - 1]) + e._widthPixels() / i.length / 2 : 0).attr("y2", "y" === c.position ? c._scale(i[i.length - 1]) - e._heightPixels() / i.length / 2 : 0)), i.forEach(function (b, c) {
            var e = {}, f = 0;
            for (f = 0; f < d.length; f += 1)
                if (d[f].aggField.join("_") === a.join("_") && d[f][j].join("_") === b.join("_")) {
                    e = d[f];
                    break
                }
            l.push({
                offset: Math.round(100 * (c / (i.length - 1))) + "%",
                color: e[g]
            })
        }, this), k ? h.selectAll("stop").data(l).transition().duration(f).attr("offset", function (a) {
            return a.offset
        }).attr("stop-color", function (a) {
            return a.color
        }) : h.selectAll("stop").data(l).enter().append("stop").attr("offset", function (a) {
            return a.offset
        }).attr("stop-color", function (a) {
            return a.color
        })
        ...
        var d = [],
            ...
            g = [b],
            h = [];
        return null !== c && void 0 !== c && (h = h.concat(c)), h = h.concat({
            ordering: b,
            desc: !1
        }), h.forEach(function (b) {
            var c;
            if ("function" == typeof b.ordering)
                for (c in a[0]) a[0].hasOwnProperty(c) && -1 === g.indexOf(c) && g.push(c);
            else b.ordering instanceof Array || g.push(b.ordering)
        }, this), d = dimple._rollUp(a, b, g), h.length >= 1 && (h.forEach(function (a) {
            var c = null === a.desc || void 0 === a.desc ? !1 : a.desc,
                d = a.ordering,
                f = [],
                g = "string" == typeof d ? d : null,
                h = function (a) {
                    var b, c = 0;
            ...
            "function" == typeof d ? e.push(function (a, b) {
                return (c ? -1 : 1) * d(a, b)
            }) : d instanceof Array ? (d.forEach(function (a) {
                f.push([].concat(a).join("|"))
            }, this), e.push(function (a, d) {
                var e, g, h = "".concat(a[b]),
                    i = "".concat(d[b]);
                return e = f.indexOf(h), g = f.indexOf(i), e = 0 > e ? c ? -1 : f.length : e, g = 0 > g ? c ? -1 : f.length : g, (c ? -1 : 1) * (e - g)
            })) : e.push(function (a, b) {
                var d = 0;
                return void 0 !== a[g] && void 0 !== b[g] && (d = i([].concat(a[g]), [].concat(b[g]))), (c ? -1 : 1) * d
            })
        }), d.sort(function (a, b) {
        ...
        return (0 >= b || null === b || void 0 === b) && (b = a.clientHeight), (0 >= b || null === b || void 0 === b) && (b = null === a.parentNode || void 0 === a.parentNode ? 0 : dimple._parseYPosition(d3.select(a).attr("height"), a.parentNode)), b
    }, dimple._parentWidth = function (a) {
        var b = a.offsetWidth;
        return (0 >= b || null === b || void 0 === b) && (b = a.clientWidth), (0 >= b || null === b || void 0 === b) && (b = null === a.parentNode || void 0 === a.parentNode ? 0 : dimple._parseXPosition(d3.select(a).attr("width"), a.parentNode)), b
    }, dimple._parseXPosition = function (a, b) {
        var c = 0,
            d = a.toString().split(",");
        return d.forEach(function (d) {
            void 0 !== d && null !== d && (isNaN(d) ? "%" === d.slice(-1) ? c += dimple._parentWidth(b) * (parseFloat(d.slice(0, d.length - 1)) / 100) : "px" === d.slice(-2) ? c += parseFloat(d.slice(0, d.length - 2)) : c = a : c += parseFloat(d))
        }, this), c
    }, dimple._parseYPosition = function (a, b) {
        var c = 0,
            d = a.toString().split(",");
        return d.forEach(function (d) {
            void 0 !== d && null !== d && (isNaN(d) ? "%" === d.slice(-1) ? c += dimple._parentHeight(b) * (parseFloat(d.slice(0, d.length - 1)) / 100) : "px" === d.slice(-2) ? c += parseFloat(d.slice(0, d.length - 2)) : c = a : c += parseFloat(d))
        }, this), c
